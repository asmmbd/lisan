export interface VocabularyWord {
  ...
  category: 'quranic' | 'hadith' | 'daily' | 'sports' | 'study' | 'travel' | 'food' | 'family'
}
...
export const vocabularyWords: VocabularyWord[] = [
  ...
  { id: '7', arabic: 'سُنَّةٌ', bengali: 'সুন্নাত / প্রথা', pronunciation: 'sunnatun', example: 'اتَّبِعْ سُنَّتِي', exampleTranslation: 'আমার সুন্নাত অনুসরণ করো', category: 'hadith' },
  ...
  { id: '18', arabic: 'جَرْيٌ', bengali: 'দৌড়', pronunciation: 'jaryun', example: 'أُحِبُّ الْجَرْيَ', exampleTranslation: 'আমি দৌড়াতে ভালোবাসি', category: 'sports' },
  ...
  { id: '21', arabic: 'دَرْسٌ', bengali: 'পাঠ / দরস', pronunciation: 'darsun', example: 'هَذَا الدَّرْسُ مُفِيدٌ', exampleTranslation: 'এই দরসটি উপকারী', category: 'study' },

  // Travel words
  { id: '22', arabic: 'سَفَرٌ', bengali: 'সফর / ভ্রমণ', pronunciation: 'safarun', example: 'السَّفَرُ مُتْعِبٌ', exampleTranslation: 'সফর ক্লান্তিকর', category: 'travel' },
  { id: '23', arabic: 'طَرِيقٌ', bengali: 'রাস্তা', pronunciation: 'tareequn', example: 'هَذَا الطَّرِيقُ طَوِيلٌ', exampleTranslation: 'এই রাস্তাটি দীর্ঘ', category: 'travel' },
  ...
  { id: '25', arabic: 'لَبَنٌ', bengali: 'দুধ', pronunciation: 'labanun', example: 'اللَّبَنُ صِحِّيٌّ', exampleTranslation: 'দুধ স্বাস্থ্যকর', category: 'food' },
...
export const categoryInfo: Record<string, { title: string; icon: string; gradient: string; count: number }> = {
  quranic: { title: 'কোরআনিক শব্দ', icon: '📖', gradient: 'from-emerald-600 to-green-700', count: 5 },
  hadith: { title: 'হাদিসের শব্দ', icon: '📿', gradient: 'from-green-600 to-teal-700', count: 5 },
  daily: { title: 'দৈনন্দিন শব্দ', icon: '🏠', gradient: 'from-teal-500 to-emerald-600', count: 5 },
  sports: { title: 'খেলাধুলা', icon: '⚽', gradient: 'from-green-500 to-lime-600', count: 3 },
  study: { title: 'পড়াশোনা', icon: '📚', gradient: 'from-emerald-500 to-green-600', count: 3 },
  travel: { title: 'ভ্রমণ', icon: '✈️', gradient: 'from-teal-600 to-green-500', count: 2 },
  food: { title: 'খাবার', icon: '🍽️', gradient: 'from-lime-500 to-green-600', count: 2 },
  family: { title: 'পরিবার', icon: '👨‍👩‍👧‍👦', gradient: 'from-green-600 to-emerald-500', count: 3 },
}

export const vocabularySets = [
  { id: 'daily100', title: 'দৈনন্দিন ১০০ শব্দ', icon: '🏠', progress: 30, total: 100, category: 'daily' },
  { id: 'sports100', title: 'খেলাধুলা ১০০ শব্দ', icon: '⚽', progress: 12, total: 100, category: 'sports' },
  { id: 'study100', title: 'পড়াশোনা ১০০ শব্দ', icon: '📚', progress: 45, total: 100, category: 'study' },
  { id: 'travel100', title: 'ভ্রমণ ১০০ শব্দ', icon: '✈️', progress: 8, total: 100, category: 'travel' },
  { id: 'food100', title: 'খাবার ১০০ শব্দ', icon: '🍽️', progress: 20, total: 100, category: 'food' },
  { id: 'family100', title: 'পরিবার ১০০ শব্দ', icon: '👨‍👩‍👧‍👦', progress: 55, total: 100, category: 'family' },
]

export const dailyWords: VocabularyWord[] = vocabularyWords.slice(0, 5)
